        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-10">
              ...
              <div className="flex items-start gap-5">
                <div className="w-12 h-12 rounded-full bg-[#03966a]/10 flex items-center justify-center flex-shrink-0 mt-1">
                  <svg className="w-6 h-6 text-[#03966a]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                  </svg>
                </div>
                <div>
                  <h3 className="text-xl font-bold text-[#03966a] mb-2">Address</h3>
              ...
              <div className="flex items-start gap-5">
                ...
                <div>
                  <h3 className="text-xl font-bold text-[#03966a] mb-2">Phone</h3>
                  <p className="text-[#022431]/80 leading-relaxed">
                    <a href="tel:9938942846" className="hover:text-[#03966a] transition-colors">9938942846</a>
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-5">
                ...
                <div>
                  <h3 className="text-xl font-bold text-[#03966a] mb-2">Email</h3>
                  <p className="text-[#022431]/80 leading-relaxed">
                    <a href="mailto:info@sarangidentistry.com" className="hover:text-[#03966a] transition-colors">info@sarangidentistry.com</a>
                  </p>
                </div>
              </div>
            </div>
          ...
          >
            <div className="p-6 pb-4">
              <h3 className="text-2xl font-bold text-[#03966a]">How To Reach Us</h3>
