    ...
    <div className="min-h-screen bg-[#f5f9eb] pt-28 pb-20 font-sans">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-10">
        ...
        >
          ...
          <div className="w-20 h-1 bg-[#1a627f] mx-auto rounded-full mb-8"></div>
          <p className="text-lg text-[#022431]/80 max-w-2xl mx-auto leading-relaxed">
            Get in touch with us for any inquiries or to schedule a visit. We are here to help you achieve your best smile.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          >
            <div className="space-y-10">
              ...
              <div className="flex items-start gap-5">
                <div className="w-12 h-12 rounded-full bg-[#1a627f]/10 flex items-center justify-center flex-shrink-0 mt-1">
                  <svg className="w-6 h-6 text-[#1a627f]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                  </svg>
                </div>
                <div>
                  <h3 className="text-xl font-bold text-[#011923] mb-2">Address</h3>
                  <p className="text-[#022431]/80 leading-relaxed">
                    7RGM+H8G Stalwart complex, Unit 4,<br />
                    Bhouma Nagar, Bhubaneswar,<br />
                    Odisha 751001
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-5">
                ...
                <div>
                  <h3 className="text-xl font-bold text-[#011923] mb-2">Phone</h3>
                  <p className="text-[#022431]/80 leading-relaxed">
                    <a href="tel:9938942846" className="hover:text-[#1a627f] transition-colors">9938942846</a>
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-5">
                ...
                <div>
                  <h3 className="text-xl font-bold text-[#011923] mb-2">Email</h3>
                  <p className="text-[#022431]/80 leading-relaxed">
                    <a href="mailto:info@sarangidentistry.com" className="hover:text-[#1a627f] transition-colors">info@sarangidentistry.com</a>
                  </p>
                </div>
              </div>
            </div>
          ...
          >
            <div className="p-6 pb-4">
              <h3 className="text-2xl font-bold text-[#011923]">How To Reach Us</h3>
