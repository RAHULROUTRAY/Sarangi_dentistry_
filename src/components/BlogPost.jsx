  ...
  if (!blog) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-[#f5f9eb] text-[#022431]">
        ...
        <p className="text-[#03966a] mb-8">
          The blog post you're looking for doesn't exist.
        </p>
        <Link
          to="/blog"
          className="group relative overflow-hidden px-6 py-3 bg-[#03966a] text-[#f5f9eb] font-bold rounded-full transition-all duration-300"
        >
  ...
  return (
    <article className="min-h-screen bg-[linear-gradient(180deg,_#f5f9eb_0%,_#e7f0e8_28%,_#cedfd8_55%,_#9ab4ad_78%,_#5f7f7b_100%)] text-[#03966a] pt-24 pb-32">
      ...
      <div className="max-w-3xl mx-auto px-6 lg:px-0">
        <div
          className="prose prose-lg prose-headings:text-[#0f1510] prose-a:text-[#03966a] hover:prose-a:text-[#056c94] prose-img:rounded-2xl max-w-none 
        ...
        <div className="mt-24 pt-12 border-t border-[#c0d2d8] flex flex-col md:flex-row items-center md:items-start gap-8">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-[#161d16] mb-4">
              Dedicated to providing top-tier oral care, modern dental therapy,
              and educating our community on the importance of lifetime dental
              health.
            </p>
            <Link
              to="/blog"
              className="text-[#03966a] font-bold hover:text-[#056c94] transition flex items-center justify-center md:justify-start gap-2"
            >
              <svg
