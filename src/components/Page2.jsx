      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-[8%] lg:gap-[6%]">
        ...
        <div className="w-full lg:w-1/2 flex flex-col gap-6">
          ...
          <motion.h2
            ...
            data-cursor="invert"
          >
            A Dental Care, Designed{" "}
            <span className="text-[#03966a]">Around Your Needs</span>
          </motion.h2>
          ...
          >
            Picking the right dentist can feel like a big decision, but we’re
            here to make it simple. We mix years of experience with a gentle
            touch so your visits are always comfortable and stress-free.
          </motion.p>
        ...
        <div className="w-full lg:w-1/2 mt-[15%] lg:mt-0 relative">
          <div className="grid grid-cols-2 gap-[4%] sm:gap-[6%]">
            ...
            <div className="flex flex-col gap-[8%] pb-[15%]">
              ...
              >
                <img
                  src="/assets/customer-Page2-4th-img.jpg"
