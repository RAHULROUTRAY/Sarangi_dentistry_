...
const CertificationPage = () => {
  ...
  return (
    <div className="bg-[#f5f9eb] min-h-screen pt-24 pb-16 px-4 md:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold text-[#03966a] mb-4">Our <span className="text-[#03966a]">Certifications</span></h1>
          <p className="text-[#022431] text-lg max-w-2xl mx-auto">
            A testament to our mastery and continuous learning in the field of modern dentistry.
          </p>
        </motion.div>
          ...
          {certificationsData.map((cert, index) => (
            ...
            >
              ...
              <div className="p-4 border-t border-[#c0d2d8]/30">
                <h3 className="text-[#03966a] font-semibold text-sm line-clamp-2">{cert.title}</h3>
              </div>
            </motion.div>
          ))}
        </div>
