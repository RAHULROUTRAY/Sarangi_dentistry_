...
export default function Page3() {
  ...
  return (
    ...
    >
      ...
      />
      <motion.div className="absolute top-1/4 left-1/4 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-[#022431] opacity-20 mix-blend-overlay rounded-full blur-[100px] pointer-events-none scale-y-50 rotate-45" />
      ...
      <div className="z-10 w-full max-w-7xl mx-auto">
        ...
        <div className="flex flex-col xl:flex-row items-center xl:items-start justify-between gap-16 xl:gap-8">
          ...
          <div className="w-full xl:w-5/12 text-[#03966a] text-center xl:text-left pt-0 xl:pt-20">
            ...
            >
              Experience a new era of proactive oral care. We blend
              state-of-the-art technology with compassionate expertise to
              deliver treatments that are as comfortable as they are effective.
            </motion.p>
            ...
            >
              Whether you need routine maintenance, a total smile makeover, or
              restorative interventions, our comprehensive service lineup
              ensures your dental health is in the hands of master clinicians.
            </motion.p>
